...
#include "ChickenRun/TP_PickUpComponent.h"
...
CHICKENRUN_API UClass* Z_Construct_UClass_UTP_PickUpComponent();
CHICKENRUN_API UClass* Z_Construct_UClass_UTP_PickUpComponent_NoRegister();
...
struct Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics
{
	struct _Script_ChickenRun_eventOnPickUp_Parms
	{
		AChickenRunCharacter* PickUpCharacter;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter = { "PickUpCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_ChickenRun_eventOnPickUp_Parms, PickUpCharacter), Z_Construct_UClass_AChickenRunCharacter_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_ChickenRun, nullptr, "OnPickUp__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::_Script_ChickenRun_eventOnPickUp_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::_Script_ChickenRun_eventOnPickUp_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnPickUp_DelegateWrapper(const FMulticastScriptDelegate& OnPickUp, AChickenRunCharacter* PickUpCharacter)
{
	struct _Script_ChickenRun_eventOnPickUp_Parms
	{
		AChickenRunCharacter* PickUpCharacter;
	};
	_Script_ChickenRun_eventOnPickUp_Parms Parms;
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp = { "OnPickUp", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTP_PickUpComponent, OnPickUp), Z_Construct_UDelegateFunction_ChickenRun_OnPickUp__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnPickUp_MetaData), NewProp_OnPickUp_MetaData) }; // 2545340749
...
template<> CHICKENRUN_API UClass* StaticClass<UTP_PickUpComponent>()
{
	return UTP_PickUpComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_emman_Documents_GitHub_ChickenRun_C___ChickenRun_Source_ChickenRun_TP_PickUpComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_PickUpComponent, UTP_PickUpComponent::StaticClass, TEXT("UTP_PickUpComponent"), &Z_Registration_Info_UClass_UTP_PickUpComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_PickUpComponent), 3533475837U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_emman_Documents_GitHub_ChickenRun_C___ChickenRun_Source_ChickenRun_TP_PickUpComponent_h_1890557904(TEXT("/Script/ChickenRun"),
	Z_CompiledInDeferFile_FID_Users_emman_Documents_GitHub_ChickenRun_C___ChickenRun_Source_ChickenRun_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_emman_Documents_GitHub_ChickenRun_C___ChickenRun_Source_ChickenRun_TP_PickUpComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
